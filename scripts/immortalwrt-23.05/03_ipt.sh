...
wget https://github.com/coolsnowwolf/lede/raw/master/package/network/utils/iptables/patches/900-bcm-fullconenat.patch -O ./package/network/utils/iptables/patches/900-bcm-fullconenat.patch
