...
# Sing-box
cp -rf ../patch/sing-box_tproxy ./package/new/openwrt_helloworld/sing-box/files
...
sed -i '/sing-box.conf/a\	$(INSTALL_CONF) ./files/nftables.conf $(1)/etc/config/sing-box' package/new/openwrt_helloworld/sing-box/Makefile
