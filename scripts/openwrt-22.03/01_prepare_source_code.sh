...
cp -f ./istoreos/include/version.mk ./openwrt/include/version.mk
cp -f ./istoreos/include/kernel.mk ./openwrt/include/kernel.mk
cp -f ./istoreos/include/kernel-5.10 ./openwrt/include/kernel-5.10
cp -f ./istoreos/include/kernel-version.mk ./openwrt/include/kernel-version.mk
cp -f ./istoreos/include/toolchain-build.mk ./openwrt/include/toolchain-build.mk
cp -f ./istoreos/include/kernel-defaults.mk ./openwrt/include/kernel-defaults.mk
cp -f ./istoreos/package/base-files/image-config.in ./openwrt/package/base-files/image-config.in
cp -f ./istoreos/version ./openwrt/version
cp -f ./istoreos/version.date ./openwrt/version.date
