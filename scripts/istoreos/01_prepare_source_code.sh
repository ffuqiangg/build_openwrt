...
# 调整分区
sed -i 's/2812MiB/1788MiB \\/' openwrt/target/linux/amlogic/meson/base-files/usr/sbin/install-to-emmc.sh
sed -i '/1788/a\		mkpart primary 1788MiB 0MiB' openwrt/target/linux/amlogic/meson/base-files/usr/sbin/install-to-emmc.sh
# 取消 argon 默认主题
