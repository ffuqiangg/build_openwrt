...
cp -rf ../patch/sing-box_tproxy ./feeds/packages/net/sing-box/files
sed -i '/sing-box.conf/a\	$(INSTALL_CONF) ./files/template.json $(1)/etc/config/sing-box' feeds/packages/net/sing-box/Makefile
sed -i '/sing-box.conf/a\	$(INSTALL_CONF) ./files/nftables.conf $(1)/etc/config/sing-box' feeds/packages/net/sing-box/Makefile
# Vsftpd
