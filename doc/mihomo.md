...
- 方法 1：在 P2P 软件中设置代理类型为 `SOCKS5`，地址为 `路由器 IP`，端口为 `10808` 。
- 方法 2：取消 `tun.route-address-set` 注释，绕过常用端口路由。
- 推荐使用方法 1，仅当 P2P 软件不支持 SOCKS5 代理时使用方法 2 。
