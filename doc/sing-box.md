...
本项目不具备订阅转换功能，如果机场没有提供 sing-box 订阅可以使用转换服务。仓库的 [另一篇文档](subscribe.md) 中有使用 sing-box-subscribe 配合本项目使用的一些简单介绍。
...
- **2026.04.04** 重新整理 config 配置文件并移除全局屏蔽 QUIC 选项。调整为开启 `advanced.override` 时默认屏蔽 YouTube 的 QUIC 流量。
