...
p "一些调整"
p "设置默认密码为 password"
    sed -i 's/root:::0:99999:7:::/root:$1$V4UetPzk$CYXluq4wUazHjmCDBCqXF.::0:99999:7:::/g' ${wrtdir}/package/base-files/files/etc/sha
...
p "一些补充翻译"
cp -rf ${ffdir}/patch/addition-trans-zh ./package/add/
