...
> [!IMPORTANT]
> 各版本固件插件略有差别：**ImmortalWrt-18.06** 不含 mihomo、Homeproxy、DAED，**ImmortalWrt-23.05** 不含 OpenClash，**LEDE** 不含 Homeproxy、DAED，**OpenWrt-23.05** 不含 Openclash、Homeproxy，**IStoreOS** 不含 Homeproxy、OpenClash、DAED。
