...
- 各固件包含的科学插件略有差别，具体区别 Releases 备注有说明。
...
- 2024.12.29 固件没有编译 sing-box 纯内核使用所需文件，如有需要可根据 release 说明一键安装。2024.03.15 的 OpenWrt-23.05 固件纯 Sing-Box 核心使用方法见 ⌈ [sing-Box 使用文档](doc/sing-box.md) ⌋
