...
- ImmortalWrt-18.06 ImmortalWrt-24.10 OpenWrt-24.10 固件采用 [Flippy](https://github.com/unifreq) 大佬的方案由 Armbian 内核打包制作，LEDE iStoreOS 为原生编译。
...
- ImmortalWrt-24.10 以及 OpenWrt-24.10 固件经过特殊优化可避免安装 kmod 内核模块时出现 pkg_hash 错误。
