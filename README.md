...
- ImmortalWrt-23.05 以及 OpenWrt-23.05 固件经过优化应该可以自由的从 opkg 或者 luci 的软件包页面安装 kmod 内核模块，不会出现 pkg_hash 错误。
...
- 本项目使用的一部分补丁取自 [YAOF](https://github.com/QiuSimons/YAOF) 项目，代码重构时也大量参考该该项目。
