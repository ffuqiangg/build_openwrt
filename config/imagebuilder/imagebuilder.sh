...
custom_packages() {
	...
	for down_url in ${mosdns_file_down}; do
		...
		echo -e "💬 The [ $mosdns_file ] is downloaded successfully."
	done
	...
	if [[ ${op_source} == openwrt ]]; then
		...
		echo -e "💬 The [ $openclash_file ] is downloaded successfully."
	...
	if [[ ${op_source} == openwrt ]]; then
		...
		echo -e "💬 The [ $luci_vlmcsd_file ] is downloaded successfully."
		...
		echo -e "💬 The [ vlmcsd ] is downloaded successfully."
