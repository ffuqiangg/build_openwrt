...
# 编译 po2lmo (如果有po2lmo可跳过) openclash
...
sed -i "21c sed -i 's/\\\\\"nas\\\\\"/\\\\\"services\\\\\"/g' /usr/lib/lua/luci/controller/filebrowser.lua" package/lean/default-settings/files/zzz-default-settings
